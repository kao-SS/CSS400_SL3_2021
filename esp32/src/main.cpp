...
#define ADC_SERVER_URL "192.168.1.121"
// #define I2S_SERVER_URL "http://192.168.1.110:5003/i2s_samples"
...
void sendData(WiFiClient *wifiClient, HTTPClient *httpClient, const char *url, uint8_t *bytes, size_t count)
{
  ...
  // httpClient->end();
  Udp.beginPacket("192.168.1.121", 4444);
  Udp.write((const uint8_t *)bytes, count);
  Udp.endPacket();
  digitalWrite(2, LOW);
}
